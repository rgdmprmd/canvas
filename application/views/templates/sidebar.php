...
<ul class="navbar-nav bg-gradient-default sidebar sidebar-light accordion" id="accordionSidebar">
    ...
    <?php
        ...
        $sqlMenu = "SELECT * FROM tb_menu m JOIN tb_access a USING(menu_id) WHERE a.role_id = {$roleId} ORDER BY m.menu_nama";
    ...
    <?php
        ...
        $sqlSubMenu = "SELECT * FROM tb_submenu s JOIN tb_menu m USING (menu_id) WHERE s.menu_id = {$menuId} AND s.submenu_status = 1 ORDER BY s.submenu_nama";
